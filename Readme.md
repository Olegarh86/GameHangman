...
---
## Описание:
Эта игра написана на Java с применением ООП
    - 'GameHangman.java' - класс для создания игры и запуска
    - 'Library.java' - класс библиотека, отвечающая за предоставление секретного слова для игры
    - 'SecretWord.txt' - класс секретное слово, отвечает за хранение и маскировку секретного слова
    - 'HangmanState.java' - класс - перечисление, отвечающий за отрисовку текущего состояния виселицы
    - 'Messages' - класс, отвечающий за взаимодействие с пользователем
    - "SecretWords.txt" - файл, в котором хранятся слова для загадывания
